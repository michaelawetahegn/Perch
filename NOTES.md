...
- 2026-09-21 — **G09b left: `SaveLinkSheet.kt:95` passes `displayName = null`** — the `OpenableColumns.DISPLAY_NAME` lookup was never built. (G09a proved the intake by tests and capped the share copy at the stream.)
