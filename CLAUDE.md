...
## The active plan is `PLAN-6.md`

Finished plans live in `docs/plans/` — v0.1 (T01–T32), v0.2 (U01–U16), v0.3 (V01–V16) and
v0.4 (W01–W12) are **complete, frozen, and history only**; never reopen a box in any of them. The **active** plan is the one at
...
`docs/plans/PLAN-4-v0.4.md` §0 still binds for everything `PLAN-6.md` §0 does not restate.

**v0.5 is being built as four sequential plans, not one.** `PLAN-5.md` (#22, the drawer,
**done** — archived in `docs/plans/`), `PLAN-6.md` (#23, pasting a link), `PLAN-7.md` (#21, reaching a blog's archive) and
...
**Every `PLAN-6.md` task is a GitHub issue.** Read it (`gh issue view N`) before starting —
...
1. Read `PLAN-6.md`, `NOTES.md`, and `git log --oneline -15`. Nothing else yet.
2. Find the **single next unchecked `[ ]` task** in PLAN-6.md. That is your entire job
